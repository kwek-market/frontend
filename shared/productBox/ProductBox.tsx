    ...
    <div className={styles.box}>
      <div className={`${styles.box_imageContainer} tw-relative`}>
        <Image
          ...
          alt="product"
        />
        <span className="tw-absolute tw-top-20 sm:tw-top-24 md:tw-top-32 xl:tw-top-52 tw-right-0 tw-m-3 tw-flex tw-flex-row hover:tw-hidden">
        ...
        <div className="tw-absolute tw-top-0 tw-left-0 tw-right-0 tw-bottom-0 tw-opacity-0 hover:tw-opacity-75 tw-z-20 tw-bg-brown-kwek300">
