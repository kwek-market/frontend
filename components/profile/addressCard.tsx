  ...
  return (
    <div className="tw-bg-white-100 tw-rounded-lg tw-p-3 tw-shadow-lg">
      ...
      <div className="tw-text-base tw-text-gray-kwek200 tw-font-normal tw-opacity-70">
        <h6 className="tw-text-base tw-text-gray-kwek200 tw-font-normal tw-opacity-70">Alison Eyo</h6>
        ...
        <h6 className="tw-text-base tw-text-gray-kwek200 tw-font-normal tw-opacity-70">+234 812 345 6789</h6>
      </div>
    </div>
  );
};
