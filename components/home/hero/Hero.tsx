  ...
  const carouselEl = [
    ...
    },
    {
      element: (
        ...
        >
          <div>
            <h4 className="tw-text-white-100 tw-uppercase tw-text-2xl md:tw-text-4xl tw-font-bold">
              black friday.
            </h4>
          </div>
          <div>
            <h3 className="tw-text-red-kwek100 tw-font-bold tw-text-xl md:tw-text-3xl">
              Save up to 50%
            </h3>
          </div>
          <div>
            <h2 className="tw-capitalize tw-text-lg md:tw-text-2xl tw-text-white-100">
              deals ends:
            </h2>
            <div>
              <span className="sm:tw-border tw-border-white-100 tw-rounded-md sm:tw-mx-2 sm:tw-p-2 tw-mr-2">
                <span className="tw-text-white-100">81</span>{" "}
                <span className="tw-text-red-kwek100">D</span>
              </span>
              <span className="sm:tw-border tw-border-white-100 tw-rounded-md sm:tw-mx-2 sm:tw-p-2 tw-mr-2">
                <span className="tw-text-white-100">17</span>{" "}
                <span className="tw-text-red-kwek100">H</span>
              </span>
              <span className="sm:tw-border tw-border-white-100 tw-rounded-md sm:tw-mx-2 sm:tw-p-2 tw-mr-2">
                <span className="tw-text-white-100">26</span>{" "}
                <span className="tw-text-red-kwek100">M</span>
              </span>
              <span className="sm:tw-border tw-border-white-100 tw-rounded-md sm:tw-mx-2 sm:tw-p-2">
                <span className="tw-text-white-100">47</span>{" "}
                <span className="tw-text-red-kwek100">S</span>
              </span>
            </div>
          </div>
          <div>
