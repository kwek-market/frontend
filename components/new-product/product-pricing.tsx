...
function ProductPricing({ submitDetails, setSubmitDetails }: UploadProductProps) {
  ...
  return (
    ...
    //     <p className='tw-font-semibold tw-capitalize tw-text-lg tw-mb-0'>product pricing & tax</p>
    //   </div>
    ...
    //         <option disabled className='disabled:tw-text-gray-800 tw-bg-gray-400' value='yes'>
    //           Yes
    //         </option>
    //       </select>
    //     </label>
