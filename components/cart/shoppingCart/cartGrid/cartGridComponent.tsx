...
const CartGridComponent = function () {
  return (
    <>
        ...
        <div className={styles.grid}>
          <div className={styles.firstBox}>
            <div className={styles.imgbox}>
              <Image src="/images/store.png" width="120" height="120" className={styles.img} />
              <button>
      ...
      <div className={`${mobileStyles.cartContainer} tw-border-b tw-pb-5 tw-border-gray-kwek100 tw-flex md:tw-hidden `}>
        ...
        <div className="tw-ml-7">
          <div>
            <span className="tw-text-xs tw-text-gray-kwek100">Seller: Nike Store</span>
          </div>
        ...
        <div className="tw-flex tw-flex-col">
          <span className="tw-text-base tw-text-black-stock tw-font-semibold">$250</span>
          <span className="tw-text-sm tw-line-through tw-text-gray-review">$150</span>
        </div>
      </div>
    </>
  );
