  ...
  const useBox = [
    {
      ...
      description: 'Register your store with a unique store URL for your store on Kwekmarkethall.com',
      image: '/images/shop.png',
      bgColor: 'tw-bg-green-success',
    },
    {
      title: 'List your products',
      description: 'Create your products, set your own prices, and make them available for purchase',
      image: '/images/list.png',
      bgColor: 'tw-bg-gray-kwek700',
    },
    {
      title: 'Sell to millions of buyers',
      description: 'Manage your orders, choose your own shipping method, and receive sales proceeds.',
    ...
    <div className={`tw-py-16 md:tw-py-24 tw-px-8 md:tw-px-14 ${Styles.Use}`}>
      <div className={` tw-flex md:tw-flex-row tw-flex-col tw-justify-between tw-w-full`}>
        <div className="tw-text-center md:tw-text-left tw-flex-1 tw-p-2 tw-my-3 md:tw-my-5 lg:tw-my-10">
          ...
          <div className="tw-w-full tw-h-[95%] tw-bg-gray-kwek800" />
        </div>
      ...
      <div className={Styles.useRegister}>
        <div className={Styles.useRegister_content}>
          <div className={Styles.useRegister_contentText}>
            <h1 className="tw-font-semibold tw-text-lg md:tw-text-4xl lg:tw-text-6xl">Sell Big, Sell Fast</h1>
            <button className={`tw-p-2 tw-truncate tw-rounded-md tw-bg-red-kwek100 tw-text-white-100 tw-flex `}>
              Register Now <i className="fas fa-long-arrow-alt-right fa-2x tw-ml-2" />
            </button>
          </div>
