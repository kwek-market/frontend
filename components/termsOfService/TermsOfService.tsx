...
these “<b><Link href="/terms-of-service" className={styles.link}>terms of use</Link></b>”, 
“<b><Link href="/privacyPolicy" className={styles.link}>our privacy policy</Link></b>” and our rally against
partiality termed 
“<b>impartiality policy</b>”.
         ...
         <p>If you are interested or you already make list any items for trade or you are registered
              ...
              .<b><Link href="/sellerPolicy" className={styles.link}>here.</Link></b>
</p>
...
.<b><Link href="/buyerPolicy" className={styles.link}>here.</Link></b>
</p>
...
<p>Contact us: <Link href="/privacyPolicy" className={styles.linka}>support@kwekmarketmall.com</Link>
</p>
